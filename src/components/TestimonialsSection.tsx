...
const testimonials: Testimonial[] = [
  {
    id: 1,
    content:
      "SEWA transformed our customer service through WhatsApp. We've seen a 40% increase in response rates and 25% faster resolution times.",
  ...
  },
  {
    id: 2,
    content:
      "The WhatsApp automation features have been a game-changer. Our sales team can now handle 3x more conversations with the same headcount.",
    author: "Michael Chen",
  ...
  },
  {
    id: 3,
    content:
      "Implementing SEWA's WhatsApp solution was surprisingly easy. We were up and running in days, not weeks, and our customer satisfaction scores have improved significantly.",
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            See how businesses are using SEWA to transform their WhatsApp
            engagement strategy and drive results.
          </p>
        </div>
