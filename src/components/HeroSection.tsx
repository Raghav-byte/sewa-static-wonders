    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight md:leading-tight lg:leading-tight mb-6 animate-slide-up"
          ...
          <div
            className="flex flex-wrap justify-center gap-6 mt-8 animate-slide-up"
          ...
          <div
            className="mt-12 md:mt-16 relative animate-slide-up"
          ...
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="md:col-span-1 border rounded-md bg-white shadow-sm">
                    ...
                    <div className="p-2">
                      ...
                      <div className="flex items-center p-2 bg-primary/5 rounded cursor-pointer">
                        <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-xs mr-2">
                          AM
                        </div>
                        <div>
                  ...
                  <div className="md:col-span-2 border rounded-md bg-white shadow-sm">
                    ...
                    <div className="p-2 border-t flex items-center">
                      <input
                        type="text"
                        className="flex-1 text-xs p-2 rounded border focus:outline-none focus:ring-1 focus:ring-primary"
            ...
            <div
              className="absolute -bottom-4 -right-4 glass-card p-3 rounded-lg shadow-md hidden md:block animate-float"
