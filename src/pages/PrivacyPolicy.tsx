      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-6 md:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4">
              This Privacy Policy describes how SEWA ("we," "us," or "our")
              collects, uses, and discloses your information when you use our
              service (the "Service"), and tells you about your privacy rights
            ...
            <p className="mb-4">
              SEWA may use Personal Data for the following purposes:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>
            ...
            <p className="mb-4">
              SEWA will retain your Personal Data only for as long as is
