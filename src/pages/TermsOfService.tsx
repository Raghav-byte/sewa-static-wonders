        ...
        <div className="container mx-auto px-6 md:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4">
              ...
              carefully before using the SEWA website and service operated by
              SEWA, a product of Simpo.ai ("us", "we", or "our").
            </p>
            ...
            <p className="mb-4">
              ...
              cancel it or SEWA cancels it. You may cancel your Subscription
              renewal either through your online account management page or by
              contacting SEWA customer support team.
            </p>

            <p className="mb-4">
              A valid payment method, including credit card, is required to
              process the payment for your Subscription. You shall provide SEWA
              with accurate and complete billing information including full
              name, address, state, zip code, telephone number, and valid
              payment information. By submitting such payment information, you
              automatically authorize SEWA to charge all Subscription fees
              incurred through your account to any such payment instruments.
            </p>

            <p className="mb-4">
              Should automatic billing fail to occur for any reason, SEWA will
            ...
            <p className="mb-4">
              SEWA may, at its sole discretion, offer a Subscription with a free
            ...
            <p className="mb-4">
              ...
              Free Trial, you will not be charged by SEWA until the Free Trial
            ...
            <p className="mb-4">
              At any time and without notice, SEWA reserves the right to (i)
            ...
            <p className="mb-4">
              SEWA, in its sole discretion and at any time, may modify the
            ...
            <p className="mb-4">
              SEWA will provide you with reasonable prior notice of any change
            ...
            <p className="mb-4">
              ...
              via email to copyright@sewa-app.com, with the subject line:
            ...
            <p className="mb-4">
              ...
              that are not owned or controlled by SEWA.
            </p>

            <p className="mb-4">
              SEWA has no control over, and assumes no responsibility for the
            ...
            <p className="mb-4">
              You acknowledge and agree that SEWA shall not be responsible or
            ...
            <p className="mb-4">
              ...
              using the Service. You may also contact us to request the deletion
              of your account.
            </p>
